...
public class TestDemoToString {
  ...
  public void testToString() {
    assertThat(new Demo().toString(), endsWith(
        "[intMember=0, boolenMember=false, longMember=0, shortMember=0, floatMember=0.0, doubleMember=0.0, byteMember=0, arrayMember=null, nonPrimitiveMember=null, typeVarMember=null]"));
  }
