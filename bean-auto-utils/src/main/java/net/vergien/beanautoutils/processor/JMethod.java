...
public class JMethod {
  ...
  public JMethod defineSignature(String accessModifier, boolean asStatic, String returnType) {
    builder.append(forInterface ? "" : accessModifier).append(asStatic ? " static " : " ")
  ...
  public JMethod defineBody(String body) {
    ...
    builder.append(") {").append(BeanUtilClass.LINE_BREAK).append(body).append(BeanUtilClass.LINE_BREAK)
        .append("}").append(BeanUtilClass.LINE_BREAK);
    return this;
  }
